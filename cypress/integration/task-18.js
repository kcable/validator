...
context(`task-18`, () => {
  ...
  it(`should not have a index.html file in the project root`, () => {
  ...
  it(`should not have the feature-initiate branch`, () => {
    cy.task('gitListBranches').then((data) => {
      ...
      ).to.not.include('feature-initiate');
    });
  });
